...
export default async function HomePage() {
  ...
  return (
    <main className="page-shell">
      <header className="site-header"><span className="lens" aria-hidden="true" /><span className="leds" aria-hidden="true"><i className="led-r" /><i className="led-y" /><i className="led-g" /></span><span className="brand-name">PokeQuery Lab</span><span className="header-status">POKÉDEX · LIVE DATA</span></header>
