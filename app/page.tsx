...
export default async function HomePage() {
  ...
  return (
    <main className="page-shell">
      <header className="site-header"><span className="brand-mark" aria-hidden="true"><i /></span><span>PokeQuery Lab</span><span className="header-status">LIVE DATA / POKEAPI</span></header>
